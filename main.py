...
sender_email = '2100520100163@ietlucknow.ac.in'
python = "nvaxsuvrjvmurgsf"
...
for i in range(len(list_of_url)):
    ...
    if final_price < to_buy_price[i]:
        ...
        connection.sendmail(from_addr=sender_email, to_addrs=sender_email, msg=f"price-alert/n/n/n {item} to buy")
        connection.close()
