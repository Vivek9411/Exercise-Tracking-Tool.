...
# get an nutritionizxc.com  andd use it to process the results 


API_ID = "Your api id " # api id from nutritionizxc.com
API_KEY = "Your api key" # api id from nutritionizxc.com
...
# api_food , api_key_food can be same as the above API_ID, API_KEY
api_food = "Your api id " # api id from nutritionizxc.com'
api_key_food "Your api key" # api id from nutritionizxc.com
